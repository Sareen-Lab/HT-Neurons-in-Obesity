...
geneset <- 1  # Specifies the data set to use
...
gene.abrv.list <- gene.abrv.df[,3]
#setwd("z://Data/RNAseq HT neurons and tissue/Andrews_files/pSI_files/pSI_results/")
write(gene.abrv.list, paste0("z://Data/RNAseq HT neurons and tissue/Andrews_files/pSI_files/pSI_results/gene_list-",geneset,"-",length,"_",strftime(Sys.time(),"%a%b%d%H%M"),".txt")); print(paste('Wrote',paste0("gene_list-",geneset,"-",length,"_",strftime(Sys.time(),"%a%b%d%H%M"),".txt")))
...
write.csv(psi.gtex, "z:/Data/RNAseq HT neurons and tissue/Andrews_files/pSI_gTEX_full_10-13-16.csv")
psi.gtex2 <- read.csv("z:/Data/RNAseq HT neurons and tissue/Andrews_files/pSI_gTEX_full_10-13-16.csv", header=T,row.names=1)
