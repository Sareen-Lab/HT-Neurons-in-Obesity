...
generate.gtex.figure <- function(ids.of.interest.full,length,output.table) {
...
########################################################################
### Generate gtex data and figures
########################################################################

length <- 2000

### Generate the plot
gtex.plot <- generate.gtex.figure(ids.of.interest.full,length,FALSE)
